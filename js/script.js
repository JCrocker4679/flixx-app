const global = {
	...
	api: {
		apiKey: '10c269dd5f59cd2b1723fe994309e327',
...
function displaySearchResults(results) {
	...
	results.forEach((result) => {
            ...
            <p class="card-text">
                <small class="text-muted">Release: ${
									global.search.type === 'movie'
										? getUkReleaseDate(result.release_date)
										: getUkReleaseDate(result.first_air_date)
								}</small>
            </p>
            </div>
        `;
		...
		).innerHTML = ` <h2>${global.search.totalResults} Results for "${global.search.term}"</h2>`;
...
// Display Top20 movies on the index page and movies page
...
//Display 20 most popular TV shows on shows page
...
async function displayPopularShows() {
	...
	results.forEach((show) => {
		...
		div.innerHTML = `  
            ...
            <p class="card-text">
                <small class="text-muted">First Aired: ${getUkReleaseDate(
									show.first_air_date
								)}</small>
            </p>
            </div>
...
async function displayMovieDetails() {
    ...
    <div class="details-top">
        ...
        <div>
            ...
            <p class="text-muted">Release Date: ${getUkReleaseDate(
							movie.release_date
						)}</p>
            <p>
            ${movie.overview}
...
async function displayShowDetails() {
    ...
    <div class="details-top">
        ...
        <div>
            ...
            <p class="text-muted">Last Aired Date: ${getUkReleaseDate(
							show.last_air_date
						)}</p>
            <p>
            ${show.overview}
...
// Format US date into UK date

function getUkReleaseDate(release_date) {
	const fullDate = release_date.split('-');
	const ukDate = fullDate[2] + '-' + fullDate[1] + '-' + fullDate[0];
	return ukDate;
}
